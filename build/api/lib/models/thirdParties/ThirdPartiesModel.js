...
const ThirdPartiesModel = sequelize.define('thirdparties', {
  ...
  countryId: {
    ...
    set(x) {
      this.setDataValue('countryId', validationID(x, false));
    }
  ...
  dId: {
    ...
    set(x) {
      this.setDataValue('dId', validationID(x, false));
    }
  ...
  ctId: {
    ...
    set(x) {
      this.setDataValue('cId', validationID(x, false));
    }
  ...
  tiId: {
    ...
    set(x) {
      this.setDataValue('tiId', validationID(x, false));
    }

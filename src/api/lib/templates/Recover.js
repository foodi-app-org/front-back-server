        ...
        <table role="presentation" min-width="400px" max-width="700px" border="0" bgcolor="#ffffff" cellpadding="0"
            ...
            <tr>
                <td align="center"> <span style="text-align: center; font-size: 30px; font-weight: bold;">
                    ...
                    </span> <span style="text-align: center; font-size: 18px; margin: 5px 60px 30px; display: block;"> Este es el codigo para acceder a tu cuenta: </span> </td>
            </tr>
            <tr>
                <td>
                    ...
                    <table border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                            <td align="center"> <span
                                    ...
                                    Este código tiene una validez de 15 minutos, contados a partir de la recepción de este correo electrónico </span> </td>
                        </tr>
                    </table>
                </td>
            </tr>

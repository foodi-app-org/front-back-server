 ...
 */
export class GetProductsSaleByPCodeRefUseCase {
  constructor(
   ...
   */
  async execute(pCodeRef: string): Promise<Product[] | null> {

    const created = await this.productRepository.getAllProductSoldByPCodeRef(pCodeRef)
    return created
  }
}
